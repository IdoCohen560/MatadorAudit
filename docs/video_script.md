...
**ZACH:** "Hello, I am Zach Bar and I am a Junior at CSUN majoring in Computer Science."

**IDO:** "Hello, I am Ido Cohen and I am a Senior at CSUN majoring in Computer Science. Together, we built MatadorAudit."

[SCREEN: Navigate to matadoraudit.netlify.app landing page, scroll to show the hero section and track badge]
...
[SCREEN: Navigate to the Upload & Analyze page on matadoraudit.streamlit.app]

**IDO:** "Let me walk you through the actual tool. Here is our live Streamlit dashboard."

### Step 1 -- Upload

[SCREEN: Click "CSUN Standard Demo" button. Dataset loads with 5,000 records. Show the dataset overview cards appear.]

**IDO:** "An administrator clicks Load Demo Data -- or uploads their own CSV. The tool instantly detects 7 demographic columns and 8 outcome columns."

### Step 2 -- Run Analysis

[SCREEN: Select race_ethnicity as demographic, financial_aid_approved as outcome, click Run Fairness Analysis. Metrics populate with color-coded risk levels.]
...
[SCREEN: Click "Multi-Audit Dashboard" in the sidebar, then click "Run All 8 Audits"]
...
[SCREEN: Click "What-If Simulator" in the sidebar, drag the threshold slider from 0.55 down to 0.40. Show metrics updating in real time.]
...
[SCREEN: Scroll down to the Next Steps section showing contact recommendations and timeline]
...
**IDO:** "For integration with existing CSUN systems, administrators would export data from Canvas LMS or PeopleSoft as CSV files and upload them directly. No IT infrastructure changes needed. In a future phase, we envision direct API connectors to these systems for automated scheduled audits."

[SCREEN: Show flow diagram on the site -- "Canvas/PeopleSoft Export -> CSV Upload -> MatadorAudit Analysis -> Fairness Report -> Admin Action"]
...
[SCREEN: Show the CSU system map with "23 campuses. 460,000+ students. One auditing standard."]
...
[SCREEN: Navigate to the Methodology section showing multiple fairness metric definitions side by side]
...
[SCREEN: Navigate to the Data Sources section on matadoraudit.netlify.app]

**IDO:** "We used AI to assist with generating natural-language fairness reports, powering the Q&A assistant, and helping structure our analysis framework. The fairness metrics themselves are computed using our own implementation based on established research by Dwork 2012, the EEOC 1978, Hardt 2016, Datta 2015, and Chouldechova 2017."

[SCREEN: Tagline fades in -- "Every Matador Deserves a Fair Shot"]

**IDO:** "Fair AI is not optional. It is an obligation. MatadorAudit. Because every Matador deserves a fair shot."
